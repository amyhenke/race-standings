export const cardData = [
    {
        ...
        slug: "virtual-lap-monza",
        category: "Virtual Lap",
        type: "Video",
        length: "6",
        image: "mediapreview1.jpg",
        content: {
    ...
    },
    {
        ...
        slug: "oracle-strategy-guide",
        category: "Oracle Strategy Guide",
        type: "Video",
        length: "4",
        image: "mediapreview2.jpg",
        content: {
    ...
    },
    {
        ...
        type: "Data",
        length: "3",
        image: "mediapreview3.jpg",
        content: {
            text: "Lectus conubia tincidunt tortor neque consequat dapibus gravida ante erat. Ad tempus id sollicitudin hendrerit tristique mattis praesent. Tortor ut cubilia tortor nam phasellus platea gravida. Auctor felis consequat fames neque egestas egestas. Imperdiet dui ut vehicula suspendisse ad velit justo suscipit. Luctus leo pellentesque luctus nisl lacinia egestas per. Non curabitur tortor turpis scelerisque nostra porttitor.",
        },
    },
];
